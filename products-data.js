...
(function () {
  ...
  // 조절볼트·마감판 — 무타공 제품(셀프시공형) 전용. 혜다움(시공형)은 시공팀이 현장에 맞춰 시공하므로 해당 없음.
  // TODO(대표 확인 필요): 3차 시제품부터 길이조절발이 없어지고 상하 프레임 연결부의 조절볼트로 높이를 조절하는 방식으로 변경됨.
  // 보정 범위(최대 50mm)는 구 길이조절발 규격(v0.18) 그대로라 새 방식 기준으로 재검토 필요.
  var ADDON_OPTION = {
    id: "footFinish",
    kind: "addon",
    label: "조절볼트 · 마감판 추가",
    description: "공간 크기에 맞춰 사이즈를 조정할 때 사용하는 부속품입니다. (보정 범위 최대 50mm)",
    default: false,
  };
  ...
  window.MUTAGONG_PRODUCTS = {
    ...
    "diy-door": {
      ...
      features: [
        ...
        { title: "가변형 구조", desc: "조절볼트·마감판으로 공간 크기 변화에 맞춰 조정할 수 있습니다." },
    ...
    accessories: {
      ...
      category: "기타",
      summary:
        "무타공랩 제품은 표준 규격에 부속품을 더해 사이즈를 조정합니다. 조절볼트와 마감판을 추가로 구매해 설치 공간에 맞출 수 있습니다.",
      features: [
        { title: "조절볼트", desc: "상단·하단 프레임 연결부에서 높이를 조정합니다. (보정 범위 최대 50mm)" },
