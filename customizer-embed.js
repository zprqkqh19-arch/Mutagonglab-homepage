...
(function(){
  ...
  $('buyBtn').onclick=function(){
    window.MUTAGONG_copyToKakao('무타공 DIY 중문 구매·상담 문의',$('sku').textContent);
    if(window.MUTAGONG_AUTH){window.MUTAGONG_AUTH.saveConfig({brand:'무타공랩',productId:'diy-door',label:'무타공 DIY 중문 구매·상담 문의',text:$('sku').textContent});}
  };
  var canvas=$('canvas');
  var ticks=[];
  function mkTicks(){
