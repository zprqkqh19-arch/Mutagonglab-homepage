...
(function(){
  ...
  mkGroup($('gDoor'),'d',[['wh','화이트'],['gr','그레이'],['bk','블랙'],['wd','우드']]);
  ...
  function render(){
    ...
    var NM={d:{wh:'화이트',gr:'그레이',bk:'블랙',wd:'우드'},g:{cl:'투명',br:'브론즈',mi:'미스트',mo:'모루',sa:'샤틴',fa:'패브릭'},h:{st:'기본',rd:'반원형',ba:'긴 바형',sb:'짧은 바형',lj:'긴 일자형',sj:'짧은 일자형'},sub:{od:'원도어',sy:'정대칭 양개형',as:'비대칭 양개형'}};
    var gansalTxt=[];
